  ...
  return (
    <>
      <footer className="">
        ...
        <div className="grid sm:p-8 p-6 md:px-24  w-full text-white bg-gradient-to-r from-blue-800 to-blue-950  grid-cols-3 sm:grid-cols-6 gap-6 lg:gap-10 lg:grid-cols-12">
    ...
    <div className="bg-white pt-8 w-full relative">
      ...
      >
       ...
       <Image
          src={plane}
          alt="logo"
          className="md:w-64 w-32 object-contain mx-4 absolute top-0 left-[40vw]"  // Added horizontal margin for spacing
        />
    </div>
  );
}