  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto space-y-9 md:space-y-16">
        ...
        >
          {/* LEFT — text */}
          <motion.div variants={fadeRight(0)} className="lg:col-span-5 space-y-7">
            ...
            <motion.ul variants={stagger} className="space-y-3">
              {traits.map((t, i) => (
                ...
                >
                  ...
                  <span className="text-zinc-700 text-sm lg:text-[15px] font-medium">{t}</span>
                </motion.li>
              ))}
            </motion.ul>
          ...
          {/* RIGHT — image */}
          <motion.div variants={fadeLeft(0.12)} className="lg:col-span-7 relative">
            {/* Main image */}
        ...
        >
          ...
          >
            ...
            <FloatingBadge value="10+"  label="Years in Immigration"  pos="-bottom-5 -right-5" />
            <FloatingBadge value="50+"  label="Expert Team Members"   pos="-top-5 -left-5" />
            ...
            <motion.ul variants={stagger} className="space-y-4">
              {expectations.map((e, i) => (
                ...
                >
                  ...
                  <span className="text-zinc-700 text-sm lg:text-[15px] font-medium">{e}</span>
                </motion.li>
              ))}
            </motion.ul>
        ...
        >
          <motion.div variants={fadeUp(0)} className="text-center space-y-4">
            ...
            <p className="text-zinc-500 text-sm lg:text-base max-w-xl mx-auto leading-relaxed">
              We regularly hire for the following roles. If you don't see a match,
              share your resume — we're always looking for exceptional talent.
            </p>
          </motion.div>
        ...
        >
          ...
          <div className="relative z-10 space-y-6 max-w-2xl mx-auto">
            ...
            <div className="flex flex-wrap items-center justify-center gap-4 pt-2">
              <a
                href="mailto:info@nexuscoreoverseas.com"
